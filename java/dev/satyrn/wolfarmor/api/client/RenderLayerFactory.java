...
public abstract class RenderLayerFactory {
     ...
     */
    @Nullable
    public static LayerRenderer<WolfEntity, WolfModel<WolfEntity>> createArmorLayer(@Nonnull LivingRenderer<?, ?> renderer) {
        try {
            ...
            return (LayerRenderer<WolfEntity, WolfModel<WolfEntity>>) clazz.getConstructor(LivingRenderer.class).newInstance(renderer);
        }
        catch(Exception e) {
            return null;
        }
     ...
     */
    @Nullable
    public static LayerRenderer<WolfEntity, WolfModel<WolfEntity>> createBackpackLayer(@Nonnull LivingRenderer<?, ?> renderer) {
        try {
